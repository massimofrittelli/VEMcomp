...
function [P, h, K, M, KS, MS, CMS, boundarynode, EGamma, ElementsCut, EGammaCut] = generate_mesh_sphere_new(Nx)
...
E3S = element2ddummy_new(P3S, true);
E4S = element2ddummy_new(P4S, true);
